...
layout = dbc.Container(children = [html.H3(html.Strong('Comparison')),
                  dcc.Markdown(comparison_description), html.Div(id='comparison_tool_page_view')], fluid=True)

@callback(
    Output('comparison_tool_page_view', 'children'),
