...
main_container =  [dcc.Markdown("**Choose the StepNo's to include histogram and boxplot for:**"),
...
pdf_generator_description = dcc.Markdown("""
...
layout = html.Div(
    [   dbc.Row([
        ...
        dbc.Row([
            pdf_generator_description
            ]),
            html.Div(id = 'pdf_generator_page_view')
            ])

@callback(
    Output('pdf_generator_page_view', 'children'),
